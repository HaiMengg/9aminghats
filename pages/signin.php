    ...
    <body>
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" id="content">
                ...
                <div class="row">
                    <p style="color: red; display: none" id="login_notif"></p>
                </div>
                <div class="row" style="margin: 5% 0% 5% 0%">
                    <form action="javascript:ProcessLoginInfo();" method="post" id="login_form">
                        <h3><b>Email</b></h3>
                        <div class="input-container input row">
                            <img src="resources/signin/email.png">
                            <input type="text" name="email" placeholder="Email đã dùng để đăng ký"/>
                        </div>
                        <br>
                        <h3><b>Mật khẩu</b></h3>
                        <div class="input-container input row">
